...
print("Pick a number")
number = input()
print("Do you want to know if it is prime or multiple of five")
print("Type 'prime' if you want to know if it's prime, or type '5' if you want to know if it's a multiple of five.")
user_input = input()
if user_input == "prime":
